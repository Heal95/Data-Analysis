...
Loc_eq_f.py - modules and functions for Iterate.py
stacoord.lst - file containing list of stations and their geolocation
Bulletins in ./BULLETINS are named in the format YYYY-MM-DD.HH-MM which defines preliminary hypocenter time of the earthquake;
